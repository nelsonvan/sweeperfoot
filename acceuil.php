...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/league des champion.jpg" class="d-block w-100" alt="...">
    </div>
...
<div class="carousel">
  ...
  <label href="#" for="image4">View image 4</label>
 <a href="article.php"><img src="img/league des champion.jpg"></a> 

  <input id="image2" type="radio" name="image-selector" />
  <label for="image1">View image 1</label>
  <img src="img/coupe d'afrique.jpg" />
